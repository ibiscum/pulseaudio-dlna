...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    serialized_pb='\n\x12\x63\x61st_channel.proto\x12\x1b\x65xtensions.api.cast_channel\"\xe3\x02\n\x0b\x43'
                  '\x61stMessage\x12R\n\x10protocol_version\x18\x01 \x02('
                  '\x0e\x32\x38.extensions.api.cast_channel.CastMessage.ProtocolVersion\x12\x11\n\tsource_id\x18\x02 '
                  '\x02(\t\x12\x16\n\x0e\x64\x65stination_id\x18\x03 \x02(\t\x12\x11\n\tnamespace\x18\x04 \x02('
                  '\t\x12J\n\x0cpayload_type\x18\x05 \x02('
                  '\x0e\x32\x34.extensions.api.cast_channel.CastMessage.PayloadType\x12\x14\n\x0cpayload_utf8\x18\x06 '
                  '\x01(\t\x12\x16\n\x0epayload_binary\x18\x07 \x01('
                  '\x0c\"!\n\x0fProtocolVersion\x12\x0e\n\nCASTV2_1_0\x10\x00\"%\n\x0bPayloadType\x12\n\n\x06STRING'
                  '\x10\x00\x12\n\n\x06\x42INARY\x10\x01\"\x0f\n\rAuthChallenge\"B\n\x0c\x41uthResponse\x12\x11\n'
                  '\tsignature\x18\x01 \x02(\x0c\x12\x1f\n\x17\x63lient_auth_certificate\x18\x02 \x02('
                  '\x0c\"~\n\tAuthError\x12\x44\n\nerror_type\x18\x01 \x02('
                  '\x0e\x32\x30.extensions.api.cast_channel.AuthError.ErrorType\"+\n\tErrorType\x12\x12\n'
                  ...
                  '\x18\x02 \x01(\x0b\x32).extensions.api.cast_channel.AuthResponse\x12\x35\n\x05\x65rror\x18\x03 '
                  '\x01(\x0b\x32&.extensions.api.cast_channel.AuthErrorB\x02H\x03') 
...
_AUTHRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='extensions.api.cast_channel.AuthResponse.client_auth_certificate', index=1,
...
class CastMessage(_message.Message, ABC):
    STRING = None

    def __init__(self):
        self.CASTV2_1_0 = None
...
class AuthChallenge(_message.Message, ABC):
    __metaclass__ = _reflection.GeneratedProtocolMessageType
...
class AuthResponse(_message.Message, ABC):
    __metaclass__ = _reflection.GeneratedProtocolMessageType
...
class AuthError(_message.Message, ABC):
    __metaclass__ = _reflection.GeneratedProtocolMessageType
...
class DeviceAuthMessage(_message.Message, ABC):
    __metaclass__ = _reflection.GeneratedProtocolMessageType
